...
<?php
$enable = get_theme_mod( 'kids_camp_testimonial_option', 'disabled' );
...
$jetpack_defaults = array(
	'page-title' => esc_html__( 'Testimonials', 'kids-camp' ),
);

// Get Jetpack options for testimonial.
$jetpack_options = get_theme_mod( 'jetpack_testimonials', $jetpack_defaults );

$headline = isset( $jetpack_options['page-title'] ) ? $jetpack_options['page-title'] : esc_html__( 'Testimonials', 'kids-camp' );
	...
	<?php endif; ?>
		...
		<div class="section-content-wrapper testimonial-content-wrapper">
			...
			<button id="testimonial-slider-prev" class="cycle-prev" aria-label="Previous">
				<span class="screen-reader-text"><?php esc_html_e( 'Previous Slide', 'kids-camp' ); ?></span><?php echo kids_camp_get_svg( array( 'icon' => 'angle-down' ) ); ?>
			</button>

			<button id="testimonial-slider-next" class="cycle-next" aria-label="Next">
				<span class="screen-reader-text"><?php esc_html_e( 'Next Slide', 'kids-camp' ); ?></span><?php echo kids_camp_get_svg( array( 'icon' => 'angle-down' ) ); ?>
			</button>
