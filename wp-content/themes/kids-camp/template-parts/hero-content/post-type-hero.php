...
if ( $kids_camp_id = get_theme_mod( 'kids_camp_hero_cont' ) ) {
	$args['page_id'] = absint( $kids_camp_id );
}
...
if ( $hero_query->have_posts() ) :
	while ( $hero_query->have_posts() ) :
		...
		$thumb = get_the_post_thumbnail_url( get_the_ID(), 'kids-camp-hero-content' );
